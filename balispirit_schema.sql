...
\restrict f88Z4mzlCd48BZHg5chQgQeMAEG3ydKnB8KbLkzQoRj9uH1YRmgEJe6Ms0WJCcy
...
--
-- Name: event_presenters; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: event_presenters event_presenters_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_presenters
    ADD CONSTRAINT event_presenters_pkey PRIMARY KEY (event_id, presenter_id);
...
--
-- Name: event_presenters event_presenters_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_presenters
    ADD CONSTRAINT event_presenters_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE;


--
-- Name: event_presenters event_presenters_presenter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_presenters
    ADD CONSTRAINT event_presenters_presenter_id_fkey FOREIGN KEY (presenter_id) REFERENCES public.presenters(id) ON DELETE CASCADE;
...
CREATE POLICY admin_manage_categories ON public.categories USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: event_presenters admin_manage_event_presenters; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_manage_event_presenters ON public.event_presenters USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: events admin_manage_events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_manage_events ON public.events USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: presenters admin_manage_presenters; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_manage_presenters ON public.presenters USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: venues admin_manage_venues; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_manage_venues ON public.venues USING (public.is_admin()) WITH CHECK (public.is_admin());
...
CREATE POLICY admins_update_all_profiles ON public.profiles FOR UPDATE USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: event_presenters; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: presenters; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: event_presenters public_read_event_presenters; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY public_read_event_presenters ON public.event_presenters FOR SELECT USING (true);


--
-- Name: events public_read_events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: presenters public_read_presenters; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY public_read_presenters ON public.presenters FOR SELECT USING (true);


--
-- Name: venues public_read_venues; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_favorites users_manage_own_favorites; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY users_manage_own_favorites ON public.user_favorites USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: objects Authenticated delete avatars; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated delete avatars" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'avatars'::text));


--
-- Name: objects Authenticated delete presenters; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated delete presenters" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'presenters'::text));


--
-- Name: objects Authenticated update avatars; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated update avatars" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'avatars'::text));


--
-- Name: objects Authenticated update presenters; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated update presenters" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'presenters'::text));


--
-- Name: objects Authenticated upload avatars; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated upload avatars" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'avatars'::text));


--
-- Name: objects Authenticated upload presenters; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated upload presenters" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'presenters'::text));


--
-- Name: objects Authenticated users can delete presenter images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can delete presenter images" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'presenters'::text));


--
-- Name: objects Authenticated users can manage presenter images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can manage presenter images" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'presenters'::text));


--
-- Name: objects Authenticated users can upload presenter images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can upload presenter images" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'presenters'::text));


--
-- Name: objects Manager Access; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Manager Access" ON storage.objects USING ((bucket_id = 'presenters'::text)) WITH CHECK ((bucket_id = 'presenters'::text));


--
-- Name: objects Public View; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public View" ON storage.objects FOR SELECT USING ((bucket_id = 'presenters'::text));


--
-- Name: objects Public read access for presenter images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read access for presenter images" ON storage.objects FOR SELECT USING ((bucket_id = 'presenters'::text));
...
--
-- Name: objects Public read presenters; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read presenters" ON storage.objects FOR SELECT USING ((bucket_id = 'presenters'::text));
...
--
-- Name: TABLE event_presenters; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.event_presenters TO anon;
GRANT ALL ON TABLE public.event_presenters TO authenticated;
GRANT ALL ON TABLE public.event_presenters TO service_role;
...
--
-- Name: TABLE presenters; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.presenters TO anon;
GRANT ALL ON TABLE public.presenters TO authenticated;
GRANT ALL ON TABLE public.presenters TO service_role;
...
--
-- Name: TABLE messages_2026_01_28; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_01_29; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_01_30; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_01_31; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2026_02_01; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict f88Z4mzlCd48BZHg5chQgQeMAEG3ydKnB8KbLkzQoRj9uH1YRmgEJe6Ms0WJCcy
